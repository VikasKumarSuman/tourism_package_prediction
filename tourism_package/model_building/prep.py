...
DATASET_PATH = "hf://datasets/vikasksuman/tourism-package-dataset/tourism.csv"
...
# Features should be categorical columns
category_columns = ['ProdTaken', 'TypeofContact', 'CityTier', 'Occupation', 'Gender', 
...
# Merge Unmarried and Single together as Single (e.g., "Unmarried" should be "Single")
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="vikasksuman/tourism-package-dataset",
        repo_type="dataset",
    )
