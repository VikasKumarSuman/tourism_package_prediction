...
This MLOps pipeline was developed by Vikas Kumar as part of the Advanced Machine Learning and MLOps course assignment.

## 📄 License

This project is only developed for educational purposes as part of the course assignment.
